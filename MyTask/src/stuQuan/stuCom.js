...
const s = width / 640;
export default class stuFabu extends Component {
    constructor(){
        super()
        this.state={
            data:'',
    ...
    componentDidMount(){
        ...
        .then((res) => {
            ...
            fetch(`http://148.70.183.184:8006/wgetquanzi/${this.state.loginstd}`, {
                method: 'GET',
                headers: {
    ...
    del=(id)=>{
       // console.log(id)
        fetch(`http://148.70.183.184:8006/deletewquanzi/${id}`, {
            method: 'DELETE',
            headers: {
                'Content-Type': 'text/plain; charset=UTF-8'
            },
